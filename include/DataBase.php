             ...
             public static function form($array = "") {
                 ...
                 foreach (self::$campos as $c):
                     if (is_array($array)) {
                         ...
                         $form .= "<label>$c</label><input class='form-control' type='text' name=" . self::$tabela . "[" . $c . "]  value='" . $valor . "' >";
                     } else {
                         $form .= "<label>$c</label><input class='form-control' type='text'  name=" . self::$tabela . "[" . $c . "]>";
                     }
                 endforeach;
